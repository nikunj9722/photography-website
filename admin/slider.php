...
<?php	
	...
	{	
			...
			{		
				...
				$get_slider_update = "select * from slider where id=$_REQUEST[edit_id]";
			...
			$sql = "insert into `slider` (`id`,`title`,`desc`,`img`) values ('','$title','$description','$sdata')";
	...
	{
		$query_edit_product="select * from slider where id=$_REQUEST[edit_id]";
	...
	if(isset($_POST["edit_product"]))
	{
			...
			$query_edit_product = "update `slider` set `title`='$title',`desc`='$description',`img`='$sdata' where `id`='$_REQUEST[edit_id]'";
			$res_edit_product = mysqli_query($con,$query_edit_product);
			if(!$res_edit_product)
			{
				die("Could Not Execute Query.".mysqli_error($con));
				...
				<div class="main-content-inner">
					...
					<div class="page-content">					
						...
						<div class="row">
								...
								<form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<div class="widget-body">
											<div class="widget-main">
													<div class="col-sm-5">
														<textarea type="text"   name="description" class="col-md-5 form-control" required style="text-transform:capitalize;" ><?php if(isset($_REQUEST["edit_id"])) { echo $fetch_edit_product["desc"]; } ?></textarea>
	                                          		</div>
											</div>
										</div>
									</div>
												...
												<?php 
													...
													<?php
														...
														foreach ($gal_image as $imgs) { ?>
								                    		<img width="70" src="uploads/slider/<?php echo $imgs; ?>" alt="<?php echo $imgs; ?>">
								                    	<?php }	?>
													</div>
													<?php	
													}												
							...
							<div class="col-xs-12">
								<h3 class="header smaller lighter blue">Slider Details</h3>
											...
											else
											{
												...
												if($num_product>0)
												{
													...
													<tr class="center">
	                                                    ...
	                                                    <td>
                                                       	...
                                                       	<td>
                                                       		<?php foreach ($gal_image as $imgs) { ?>
									                    		<a href="uploads/slider/<?php echo $imgs; ?>" target="_blank">
									                    			<img width="70" src="uploads/slider/<?php echo $imgs; ?>" alt="<?php echo $imgs; ?>">
									                    		</a>
									                    	<?php
									                    		} 
														...
														<td>
															<a href="slider.php?edit_id=<?php echo $fetch_product["id"]; ?>"><i class="ace-icon fa fa-pencil bigger-130"></i></a>
														</td>
														<td>
															<a href="javascript: del_slider(<?php echo $fetch_product["id"]; ?>)"><i class="ace-icon fa fa-trash-o bigger-130 red"></i></a>
														</td>
