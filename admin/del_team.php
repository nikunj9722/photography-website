<?php 
	...
	$get_team_pro = "select * from team where id = '$del_id'";
	$res_edit_product=mysqli_query($con,$get_team_pro);
	if(!$res_edit_product)
	{
	...
	$delete_product="delete from team where id=$del_id";
		...
		else
		{
			...
			if($num_product>0)
			{
                ...
                <tr class="center">
                    ...
                    <td>
						<img src="uploads/team/<?php echo $fetch_product["img"]; ?>" width="100" height="70">			
					</td>
                    <td>
                        <a href="team.php?edit_id=<?php echo $fetch_product["id"]; ?>">Edit</a>
                    </td>
                    <td>
                        <a href="javascript: del_team(<?php echo $fetch_product["id"]; ?>)">Delete</a>
                    </td>
                </tr>
				<?php
					$c++;
